...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setText(millisUntilFinished / 1000 + "秒可重新发送");  //设置倒计时时间
//        mTextView.setBackgroundResource(R.drawable.validate_code_press_bg); //设置按钮为灰色，这时是不能点击的
        ...
        ForegroundColorSpan span = new ForegroundColorSpan(Color.parseColor("#009F64"));
        /**
    ...
    public void onFinish() {
        ...
        mTextView.setTextColor(Color.parseColor("#55a87f"));
